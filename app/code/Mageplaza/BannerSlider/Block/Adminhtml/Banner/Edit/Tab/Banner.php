...
use Mageplaza\BannerSlider\Block\Adminhtml\Banner\Edit\Tab\Render\Mobileimage as MobileImage;
use Mageplaza\BannerSlider\Block\Adminhtml\Banner\Edit\Tab\Render\Slider;
use Mageplaza\BannerSlider\Block\Adminhtml\Banner\Edit\Tab\Render\Tabletimage as TabletImage;
use Mageplaza\BannerSlider\Helper\Data;
use Mageplaza\BannerSlider\Helper\Image as HelperImage;
use Mageplaza\BannerSlider\Helper\MobileImage as HelperMImage;
use Mageplaza\BannerSlider\Helper\TabletImage as HelperTImage;
...
class Banner extends Generic implements TabInterface
{
    ...
    public function __construct(
        ...
        HelperTImage $imageTHelper,
        HelperMImage $imageMHelper,
    ...
    protected function _prepareForm()
    {
        ...
        $uploadBanner1 = $fieldset->addField('tabletimage', TabletImage::class, [
            'name' => 'tabletimage',
            'label' => __('Upload Tablet Image'),
            'title' => __('Upload Tablet Image'),
            'path' => $this->imageTHelper->getBaseMediaPath(HelperTImage::TEMPLATE_MEDIA_TYPE_BANNER_TABLET),
        ]);

        $uploadBanner2 = $fieldset->addField('mobileimage', MobileImage::class, [
            'name' => 'mobileimage',
            'label' => __('Upload Mobile Image'),
            'title' => __('Upload Mobile Image'),
            'path' => $this->imageMHelper->getBaseMediaPath(HelperMImage::TEMPLATE_MEDIA_TYPE_BANNER_MOBILE),
        ]);
        ...
        $dependencies = $this->getLayout()->createBlock(Dependence::class)
            ...
            ->addFieldMap($uploadBanner1->getHtmlId(), $uploadBanner1->getName())
            ->addFieldMap($uploadBanner2->getHtmlId(), $uploadBanner2->getName())
