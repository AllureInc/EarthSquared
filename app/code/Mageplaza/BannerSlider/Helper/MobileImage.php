 ...
 */
class MobileImage extends AbstractData
{
    const TEMPLATE_MEDIA_PATH = 'mageplaza/bannerslider';
    const TEMPLATE_MEDIA_TYPE_BANNER_MOBILE = 'banner/mobileimage';
     ...
     * @return $this
     */
    public function uploadImage(&$data, $fileName = 'mobileimage', $type = '', $oldImage = null)
    {
        if (isset($data[$fileName]['delete']) && $data[$fileName]['delete']) {
            ...
            try {
                ...
                $data['mobileimage'] = $this->_prepareFile($image['file']);
            } catch (Exception $e) {
                $data['mobileimage'] = isset($data['mobileimage']['value']) ? $data['mobileimage']['value'] : '';
            }
        }
