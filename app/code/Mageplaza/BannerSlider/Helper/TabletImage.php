 ...
 */
class TabletImage extends AbstractData
{
    const TEMPLATE_MEDIA_PATH = 'mageplaza/bannerslider';
    const TEMPLATE_MEDIA_TYPE_BANNER_TABLET = 'banner/tabletimage';
     ...
     * @return $this
     */
    public function uploadImage(&$data, $fileName = 'tabletimage', $type = '', $oldImage = null)
    {
        if (isset($data[$fileName]['delete']) && $data[$fileName]['delete']) {
            ...
            try {
                ...
                $data['tabletimage'] = $this->_prepareFile($image['file']);
            } catch (Exception $e) {
                $data['tabletimage'] = isset($data['tabletimage']['value']) ? $data['tabletimage']['value'] : '';
            }
        }
