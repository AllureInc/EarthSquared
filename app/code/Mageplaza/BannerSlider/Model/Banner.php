...
use Mageplaza\BannerSlider\Model\Config\Source\Mobileimage as configMImage;
use Mageplaza\BannerSlider\Model\Config\Source\Tabletimage as configTImage;
...
class Banner extends AbstractModel
{
     ...
     * @param configTImage $configTImage
     * @param configMImage $configMImage
    ...
    public function __construct(
        ...
        configTImage $configTImage,
        configMImage $configMImage,
        ...
        $this->imageTModel = $configTImage;
        $this->imageMModel = $configMImage;
    ...
    {
        return $this->imageTModel->getBaseUrl() . $this->getTabletimage();
    }
    ...
    {
        return $this->imageMModel->getBaseUrl() . $this->getMobileimage();
    }
