...
class Config extends GatewayConfig
{
    ...
    const KEY_ORDER_CREATE = 'order_create';
    /**#@-*/
    ...
    public function getValue($field, $storeId = null)
    {
        ...
        if($this->getAreaCode() == 'adminhtml'){
            ...
            $iwdStoreId = $this->getStoreId();

            if($this->request->getControllerName() == self::KEY_ORDER_CREATE &&
                isset($iwdStoreId) && $iwdStoreId != $scopeId){
                $scopeId = $iwdStoreId;
            }
        }
