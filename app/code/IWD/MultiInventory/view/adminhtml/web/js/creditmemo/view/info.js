define([
        'jquery',
        'IWD_MultiInventory/js/order/view/actions',
        'jquery/ui'
    ],
    ...
    function ($, actions) {
        ...
        $.widget('mage.iwdMultiInventoryCreditmemoInfo', $.mage.iwdMultiInventoryActions, {
            options: {
                urlUpdate: '',
                urlForm: '',
        ...
        return $.mage.iwdMultiInventoryCreditmemoInfo;
    });