...
function($, modal, $t, Warehouse){
    'use strict';

    $.widget('mage.iwdMultiInventoryActions', {
        options: {
            urlUpdate: '',
            urlForm: '',
        ...
        showMultistockModal: function(response){
            Warehouse.preview(response);
        },

        additionalInfoUpdate:function()
        {
            if (iwdMultiInventoryAdditional.validateForm()) {
                iwdMultiInventoryAdditional.confirmUpdate();
                this.showPreLoader();
        ...
        additionalInfoCancel:function()
        {
            if (this.additionalAction == false) {
                this.additionalAction = true;
                iwdMultiInventoryAdditional.confirmUpdate({'skip_save': '1'});
                this.showPreLoader();
            }
        },
    ...
    return $.mage.iwdMultiInventoryActions;
});